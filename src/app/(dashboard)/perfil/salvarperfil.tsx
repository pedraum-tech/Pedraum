...
import TaxonomyQuickSearch, {
  TaxonomyPath,
} from "@/features/search/TaxonomyQuickSearch";

/** ==== PDF (SSR desativado para evitar erro no Next) ==== */
const PDFUploader = dynamic(() => import("@/features/documents/PDFUploader"), {
  ssr: false,
}) as any;
const DrivePDFViewer = dynamic(() => import("@/features/documents/DrivePDFViewer"), {
  ssr: false,
}) as any;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              ...
              <ImageUploader
                ...
                docId={userId ?? undefined}    // <--- Coloque aqui a variável que guarda o ID do usuário logado
