...
const PDFUploader = dynamic(() => import("@/features/documents/PDFUploader"), { ssr: false }) as any;
const DrivePDFViewer = dynamic(() => import("@/features/documents/DrivePDFViewer"), { ssr: false }) as any;
