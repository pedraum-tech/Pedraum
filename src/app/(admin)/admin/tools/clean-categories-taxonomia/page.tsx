      ...
      <div className="w-full max-w-4xl bg-slate-900/70 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-semibold transition ${loading || taxLoading
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-semibold transition ${deleting || !toDelete || toDelete.length === 0
              ? "bg-slate-700 text-slate-400 cursor-not-allowed"
