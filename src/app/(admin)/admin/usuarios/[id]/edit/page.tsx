...
const PDFUploader = dynamic(() => import("@/features/documents/PDFUploader"), { ssr: false });
const DrivePDFViewer = dynamic(() => import("@/features/documents/DrivePDFViewer"), { ssr: false });
